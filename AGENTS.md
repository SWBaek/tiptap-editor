...
- `npm run sdoc -- export examples/sdoc-json/basic.document.json --format docx --template-file company.dotx -o handoff.docx`: validate an external Word template and inject SDoc body content into its `sdoc-body` content control.
