...
- `npm run sdoc -- export examples/sdoc-json/basic.document.json --format docx --template-file company.dotx --template-style heading=CorpHeading -o handoff.docx`: validate an external Word template, inject SDoc body content into `sdoc-body`, and apply mapped Word styles.
