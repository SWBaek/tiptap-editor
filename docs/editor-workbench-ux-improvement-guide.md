...
Only the final review gate stays open. Compact folder chains, multi-select, and drag/drop remain deferred until user evidence justifies their interaction models. The authoritative live evidence record is `docs/goal-prompt/phase-5.3-explorer-sidebar-ux.md`.
