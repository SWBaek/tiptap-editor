...
| Selected-text Bubble Menu | Adapt | Partial. Bold, italic, underline, strike, code, and cross-reference preserve the captured selection; normal-link and sub/superscript controls remain in the writing-essentials slice. | Common inline marks work on selection; focus/selection is preserved and covered by E2E. |
