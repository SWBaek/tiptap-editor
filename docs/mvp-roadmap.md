...
- asset-backed large data grid minimal model 및 controlled corporate HTML/PDF template export 완료; row-level grid workflows와 `.docx`/strict pagination은 후속 slice
